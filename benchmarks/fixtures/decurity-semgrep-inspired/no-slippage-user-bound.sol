...
contract SafeNoSlippageUserBound {
    function swap(IRouterLike router, uint256 amountIn, uint256 minOut, address[] calldata path, address to, uint256 deadline) external {
