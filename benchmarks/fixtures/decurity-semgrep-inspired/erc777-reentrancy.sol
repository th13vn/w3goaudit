...
contract VulnerableERC777Reentrancy {
    function notify(IERC777HookLike hook, address from, address to, uint256 amount, bytes calldata data) external {
        hook.tokensReceived(msg.sender, from, to, amount, data, data);
    }
}
