...
// Safe invariant cases. These should stay quiet and become false positives if
// a scanner ignores authorization, value binding, inheritance, or exact API
// semantics.

contract SafeArbitraryLowLevelCallOwnerOnly {
