...
contract VulnerableNoSlippageExactETH {
    function swapEth(IRouterLike router, address[] calldata path, address to, uint256 deadline) external payable {
        router.swapExactETHForTokens{value: msg.value}(0, path, to, deadline);
    }
}
