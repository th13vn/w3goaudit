...
contract VulnerableKeeperOracleManipulation {
    function quote(IKeeperLike keeper, address tokenIn, uint256 amountIn, address tokenOut) external view returns (uint256) {
        return keeper.current(tokenIn, amountIn, tokenOut);
    }
}
