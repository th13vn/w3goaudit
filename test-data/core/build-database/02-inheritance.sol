...
// MyToken inherits from Pausable and Ownable (both inherit Context), plus the
// IERC20 and IOwnable interfaces.
// In Solidity the LAST-listed base is most-derived, so the C3 linearization
// (derived-first, verified against solc 0.8.20) is:
//   MyToken -> IOwnable -> IERC20 -> Ownable -> Pausable -> Context
