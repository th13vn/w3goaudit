    ...
    def test_main_builds_shared_chains_when_w3goaudit_is_not_selected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            args = SimpleNamespace(
                ...
                timeout=180,
                w3goaudit_bin="",
                config_dir="scripts/benchmark/config",
                semgrep_config="scripts/benchmark/config/semgrep-decurity",
                naly3er_cmd="",
            )
            metric = {
                "precision": 0.0,
...
class MarkdownReportingTest(unittest.TestCase):
    def test_markdown_matches_the_pre_extraction_baseline_exactly(self):
        report = {
            ...
            "corpus": {
                "name": "Fixed Corpus",
                "path": "scripts/benchmark/corpus/fixed.json",
                "cases": [
                    {
                        "id": "case-a",
                        "expected": [
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            expected = textwrap.dedent(
                ...
                - Corpus: `Fixed Corpus`
                - Corpus file: `scripts/benchmark/corpus/fixed.json`
                - Cases: `1`
                - Expected bugs: `2`
                - Bug categories: `2`
