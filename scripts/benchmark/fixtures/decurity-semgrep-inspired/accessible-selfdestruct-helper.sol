...
// Advanced vulnerable flows. These keep the same bug class, but move the
// sensitive value through aliases, helper calls, or less common API variants.

contract VulnerableAccessibleSelfdestructHelper {
    function destroy(address receiver) public {
        _destroy(receiver);
    }

    function _destroy(address receiver) internal {
