...
contract VulnerableSenseMissingOracleAccessControl {
    function submit(uint256 request, uint256 lastBlock) external {
        _updateOracle(lastBlock, 1, 2);
    }

    function _updateOracle(uint256 lastBlock, uint256 a, uint256 b) internal {
    }
}
